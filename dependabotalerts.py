...
load_dotenv()
# GitHub API token with necessary permissions from the secret manager
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN")
if not GITHUB_TOKEN:
    raise Exception("GITHUB_TOKEN is missing from environment variables. Please set it in your .env file.")
...
def main():
    ...
    send_summary_to_excluded_users(alerts_by_repo, email_map)  # Pass email_map here
